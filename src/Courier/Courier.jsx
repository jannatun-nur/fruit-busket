const Courier = () => {
  return (
    <div className=" bg-whitept-20 mt-4">
      <div className="lg:flex lg:justify-evenly flex justify-between md:flex md:justify-around">
        <section className="mt-8 lg:mt-0">
          <img
            className="absolute w-20 h-16 lg:h-40 lg:w-56 md:w-20"
            src="https://i.ibb.co/XDnC6Tn/deli2.jpg"
            alt=""
          />
          <img
            className="relative top-10 left-10 lg:top-32 lg:left-32 h-14 w-20 lg:h-32 lg:w-52 md:h-20 md:w-24 "
            src="https://i.ibb.co/7z4fDmp/del3.jpg"
            alt=""
          />
        </section>
        <section>
          <p className="text-rose-600 text-sm md:text-xl lg:text-xl">Home Delivery</p>
          <p className="w-48 md:w-72 lg:w-80 text-gray-800 text-sm lg:text-2xl">
